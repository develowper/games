          ...
          <table class="w-full text-sm text-left text-gray-500">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50">
              ...
              <tr class="text-sm text-center">
                ...
                <th
                  ...
                  class="px-2 py-3 cursor-pointer duration-300 hover:text-gray-500 hover:scale-[105%]"
                  @click="
                    (params.order_by = 'clear_count'),
                      (params.dir = params.dir == 'ASC' ? 'DESC' : 'ASC'),
                      getData('clear')
                  "
                >
                  <div class="flex items-center justify-center">
                    <span class="px-2"> {{ __('game') }} </span>
                    <ArrowsUpDownIcon class="w-4 h-4" />
                  </div>
                </th>
                <th
                  ...
                  class="px-2 py-3 cursor-pointer duration-300 hover:text-gray-500 hover:scale-[105%]"
                  @click="
                    (params.order_by = 'max_cards_count'),
                      (params.dir = params.dir == 'ASC' ? 'DESC' : 'ASC'),
                      getData('clear')
                  "
                >
                  <div class="flex items-center justify-center">
                    <span class="px-2"> {{ __('game_card') }} </span>
                    <ArrowsUpDownIcon class="w-4 h-4" />
                  </div>
                </th>
                <th
                  ...
                  class="px-2 py-3 cursor-pointer duration-300 hover:text-gray-500 hover:scale-[105%]"
                  @click="
                    (params.order_by = 'max_user_cards_count'),
                      (params.dir = params.dir == 'ASC' ? 'DESC' : 'ASC'),
                      getData('clear')
                  "
                >
                  <div class="flex items-center justify-center">
                    <span class="px-2"> {{ __('user_card') }} </span>
                    <ArrowsUpDownIcon class="w-4 h-4" />
                  </div>
                </th>
                <th
                  ...
                  class="px-2 py-3 cursor-pointer duration-300 hover:text-gray-500 hover:scale-[105%]"
                  @click="
                    (params.order_by = 'win_score'),
                      (params.dir = params.dir == 'ASC' ? 'DESC' : 'ASC'),
                      getData('clear')
                  "
                >
                  <div class="flex items-center justify-center">
                    <span class="px-2"> {{ __('score') }} </span>
                    <ArrowsUpDownIcon class="w-4 h-4" />
                  </div>
                </th>
                <th
                  ...
                  class="px-2 py-3 cursor-pointer duration-300 hover:text-gray-500 hover:scale-[105%]"
                  @click="
                    (params.order_by = 'max_seconds'),
                      (params.dir = params.dir == 'ASC' ? 'DESC' : 'ASC'),
                      getData('clear')
                  "
                >
                  <div class="flex items-center justify-center">
                    <span class="px-2"> {{ __('waiting') }} </span>
                    <ArrowsUpDownIcon class="w-4 h-4" />
                  </div>
                </th>
                <th
                  ...
                  class="px-2 py-3 cursor-pointer duration-300 hover:text-gray-500 hover:scale-[105%]"
                  @click="
                    (params.order_by = 'commission_percent'),
                      (params.dir = params.dir == 'ASC' ? 'DESC' : 'ASC'),
                      getData('clear')
                  "
                >
                  <div class="flex items-center justify-center">
                    <span class="px-2"> {{ __('commission_percent') }} </span>
                    <ArrowsUpDownIcon class="w-4 h-4" />
                  </div>
                </th>
                <th
                  ...
                  class="px-2 py-3 cursor-pointer duration-300 hover:text-gray-500 hover:scale-[105%]"
                  @click="
                    (params.order_by = 'row_win_percent'),
                      (params.dir = params.dir == 'ASC' ? 'DESC' : 'ASC'),
                      getData('clear')
                  "
                >
                  <div class="flex items-center justify-center">
                    <span class="px-2"> {{ __('row_win_percent') }} </span>
                    <ArrowsUpDownIcon class="w-4 h-4" />
                  </div>
                </th>
                <th
                  ...
                  class="px-2 py-3 cursor-pointer duration-300 hover:text-gray-500 hover:scale-[105%]"
                  @click="
                    (params.order_by = 'win_percent'),
                      (params.dir = params.dir == 'ASC' ? 'DESC' : 'ASC'),
                      getData('clear')
                  "
                >
                  <div class="flex items-center justify-center">
                    <span class="px-2"> {{ __('win_percent') }} </span>
                    <ArrowsUpDownIcon class="w-4 h-4" />
                  </div>
                </th>
                <th
            ...
            <tbody class=" ">
              ...
              <tr v-for="(d, idx) in data" class="bg-white text-center border-b hover:bg-gray-50">
                ...
                <td class="px-2 py-4">
                  <Link :href="route('admin.panel.room.edit', { params: { id: d.id } })">{{
                    `${__(d.title)}` || '-'
                  }}</Link>
                </td>

                <td class="px-2 py-4">
                  <div>{{ asPrice(d.cardPrice) }}</div>
                </td>
                <td class="px-2 py-4">
                  <div>{{ asPrice(d.clearCount) }}</div>
                </td>
                <td class="px-2 py-4">
                  <div>{{ d.maxCardsCount }}</div>
                </td>
                <td class="px-2 py-4">
                  <div>{{ d.maxUserCardsCount }}</div>
                </td>
                <td class="px-2 py-4">
                  <div>{{ d.winScore }}</div>
                </td>
                <td class="px-2 py-4">
                  <div>{{ d.maxSeconds }}</div>
                </td>
                <td class="px-2 py-4">
                  <div>{{ d.commissionPercent }}</div>
                </td>
                <td class="px-2 py-4">
                  <div>{{ d.rowWinPercent }}</div>
                </td>
                <td class="px-2 py-4">
                ...
                <td class="px-2 py-4" data-te-dropdown-ref>
                  <button
                    ...
                    :class="`bg-${d.isActive == 1 ? 'green' : 'red'}-100 hover:bg-${d.isActive == 1 ? 'green' : 'red'}-200 text-${d.isActive == 1 ? 'green' : 'red'}-500`"
                  >
                    {{ d.isActive == 1 ? __('active') : __('inactive') }}
                  </button>
                  <ul
                    :ref="`statusMenu${d.id}`"
                    data-te-dropdown-menu-ref
