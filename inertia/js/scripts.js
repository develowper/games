...
window.tailwindElements = () => {
  ...
  initTE(
    { Popover, Tooltip, Ripple, Input, Select, Alert, Toast, Sidenav, Modal },
    {
      // allowReinits: true,
      autoReinits: true,
  ...
  // }
  document
    .querySelectorAll('[data-te-input-notch-ref]')
    .forEach((el) => el.setAttribute('dir', 'ltr'))
  ...
  if (modalEl) window.Modal = new Modal(modalEl)
  if (sideNavEl)
    // if (!window.Sidenav) {
